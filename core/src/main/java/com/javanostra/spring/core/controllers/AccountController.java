...
//    public ResponseEntity<String> setEmail(@RequestParam("email") String email){
//        try {
//            if (userService.userExistsByEmail(email)) {
//                return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Почта " + email + " уже занята!");
//            }
//
//            User currentUser = userService.getCurrentUser();
//
...
//                userService.updateUser(currentUser);
//                return ResponseEntity.ok("Почта обновлена!");
//            }
//
//            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body("Нет авторизации!");
//        } catch (NoSuchElementException exception){
//            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Ошибка запроса");
//        }
//    }
...
//    public ResponseEntity<ResponseDTO> setUsername(@RequestParam("username") String username){
//        try {
//            if (userService.userExists(username)) {
//                return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ResponseDTO(HttpStatus.BAD_REQUEST.value(),"Имя " + username + " уже занято!"));
//            }
//
//            User currentUser = userService.getCurrentUser();
//
...
//                userService.updateUser(currentUser);
//                return ResponseEntity.ok(new ResponseDTO(HttpStatus.OK.value(), "Имя обновлено!"));
//            }
//
//            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(new ResponseDTO(HttpStatus.UNAUTHORIZED.value(), "Нет авторизации!"));
//        }catch (NoSuchElementException exception){
//            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ResponseDTO(HttpStatus.BAD_REQUEST.value(), "Ошибка запроса"));
//        }
//    }
