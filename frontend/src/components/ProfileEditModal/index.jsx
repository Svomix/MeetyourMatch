...
export default ({ active, setActive }) => {
  ...
  useEffect(() => {
    ...
    function clickEvent(e) {
      ...
      if (!clickInside) setActive(false);
    }
  ...
  return (
    <dialog ref={dialog} className={styles.modal}>
      ...
      <div className={styles.input_wrapper}>
        <p className={styles.param_name}>Изменить имя</p>
        <InputField
      ...
      <div className={styles.input_wrapper}>
        <p className={styles.param_name}>Изменить пароль</p>
        <InputField
          className={styles.input}
          value={password || ''}
      ...
      <div className={styles.btns_wrapper}>
        <button onClick={() => setActive(false)} className={styles.cancel_button}>
          Отмена
        </button>
